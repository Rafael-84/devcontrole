            ...
            <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div ref={modalRef} className="bg-white shadow-lg w-4/5 md:w-1/2 max-w-2xl p-3 rounded">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button onClick={handleModalVisible} className="bg-red-500 p-1 text-white rounded cursor-pointer hover:bg-red-600 duration-300">Fechar</button>
                    ...
                    <div className="w-full border-b-[1.5px] my-4 border-slate-200"></div>
